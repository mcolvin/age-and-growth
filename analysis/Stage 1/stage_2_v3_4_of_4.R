	...
	for(n in c(1:2))
		...
		for(ll in c(1:length(bin_n)))
			...
			for(i in c(1:nsims))
				...
				if("ma_stage_2_4_of_4.csv" %in% dir("./output")==FALSE)
					{write.csv(stage_2_ma,"./output/ma_stage_2_4_of_4.csv")} else
					{write.table(stage_2_ma,"./output/ma_stage_2_4_of_4.csv",append=TRUE, col.names=FALSE,sep=',')}		
				...
				if("af_stage_2_4_of_4.csv" %in% dir("./output")==FALSE)
					{write.csv(stage_2_af,"./output/af_stage_2_4_of_4.csv")} else
					{write.table(stage_2_af,"./output/af_stage_2_4_of_4.csv",append=TRUE, col.names=FALSE,sep=',')}
				...
				if("mla_stage_2_4_of_4.csv" %in% dir("./output")==FALSE)
					{write.csv(stage_2_mla,"./output/mla_stage_2_4_of_4.csv")} else
					{write.table(stage_2_mla,"./output/mla_stage_2_4_of_4.csv",append=TRUE, col.names=FALSE,sep=',')}						
				}# i
			}# ll
		} #n
	} # kk
